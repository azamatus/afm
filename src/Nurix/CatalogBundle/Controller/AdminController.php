        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                if (stripos($original_file, 'xls')) {
                    ...
                    $info = $this->get('catalog.product.importparser')->parseExcel($excel_file);
                ...
                $this->redirect($this->container->get('sonata.admin.goods')->generateUrl('excelImport'));
    ...
    public function excelGoodsUploadAction(Request $request)
    {
        ...
        if ($request->isMethod('POST')) {
            ...
            if ($form->isValid()) {
                ...
                $this->redirect($this->container->get('sonata.admin.goods')->generateUrl('excelGoodsUpload'));
